...
while True:
    os.system('cls')
    os.system('clear')
    print("""As regras são simples: Papel ganha de Pedra, Pedra ganha de Tesoura e Tesoura ganha de Papel. Divirta-se :) """)
    ...
    if escolhamodo==1:
        ...
        while continuar == 1:
            ...
            if jogador1 != 1 and jogador1 != 2 and jogador1 !=3 or jogador2 != 1 and jogador2 != 2 and jogador2 != 3:
